      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Additional Bonus</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">No additional bonus records found</div>
          ) : (
            <div className="space-y-4">
              {data.map((record) => (
                <div key={record._id} className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    <p className="font-medium">{record.description || 'Additional Bonus'}</p>
